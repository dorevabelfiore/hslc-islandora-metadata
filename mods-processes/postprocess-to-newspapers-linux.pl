...
foreach my $infile (@files)
{
	...
	system("java -Xmx1000M -Xms1000M -cp /usr/share/java/saxon.jar net.sf.saxon.Transform -t -o:$outfile -s:_tmp.1 -xsl:cdm-mods-final-level-to-newspapers.xsl islandora-namespace=islandora");
